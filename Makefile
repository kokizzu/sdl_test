#############################################################################
# Makefile for building: sdl_try
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  sdl_try.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile sdl_try.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = sdl_try1.0.0
DISTDIR = /home/kyz/sdl_try/.tmp/sdl_try1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		sdl_try.pro  main.cpp
QMAKE_TARGET  = sdl_try
...
Makefile: sdl_try.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		sdl_try.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile sdl_try.pro
